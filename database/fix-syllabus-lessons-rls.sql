-- =====================================================================
-- Fix: Syllabus Lessons RLS Policies
...
-- Policy 1: Everyone can view active lessons (read-only for students)
CREATE POLICY "Anyone can view active lessons" ON syllabus_lessons
  FOR SELECT
...
-- Policy 1: Everyone can view active syllabi
