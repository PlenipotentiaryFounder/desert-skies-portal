...
export const metadata = {
  title: "Student Document | Desert Skies",
  description: "View student document details for Desert Skies Flight School",
}
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant="outline">
            <Link href="/instructor/documents">Back to Documents</Link>
          </Button>
          {!document.is_verified && <VerifyDocumentButton id={params.id} />}
        </div>
      </div>
