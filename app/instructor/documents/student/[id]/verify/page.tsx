...
export const metadata = {
  title: "Verify Student Document | Desert Skies",
  description: "Verify student document for Desert Skies Flight School",
}
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Review and verify document for {document.profiles.first_name} {document.profiles.last_name}
          </p>
        </div>
        <Button asChild variant="outline">
          <Link href="/instructor/documents">Cancel</Link>
        </Button>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Review the document before verification</CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Verify this document if the information is correct</CardDescription>
        </CardHeader>
        <CardContent>
