...
import { DeleteFlightSessionDialog } from "@/app/admin/schedule/delete-flight-session-dialog"

interface InstructorFlightSessionsListProps {
  initialSessions: FlightSession[]
}

export function InstructorFlightSessionsList({ initialSessions }: InstructorFlightSessionsListProps) {
    ...
    <div className="space-y-4">
      <div className="flex flex-col gap-4 sm:flex-row">
        <div className="flex-1">
          <Input
            placeholder="Search by student, aircraft, or lesson..."
            value={searchTerm}
