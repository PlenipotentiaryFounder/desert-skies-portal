  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: `${values.year} ${values.make} ${values.model} (${values.tail_number}) has been added successfully.`,
      })
      ...
      toast({
        title: "Error",
        description: error.message || "Failed to add aircraft. Please try again.",
        variant: "destructive",
      })
    } finally {
    ...
    <div className="container mx-auto py-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Add a new aircraft to your flight school's fleet</CardDescription>
        </CardHeader>
        <Form {...form}>
