export default function InstructorEnrollmentConfirmationEmail({ instructorName = "Instructor", studentName = "Student", syllabusTitle = "Syllabus", syllabusLink = "#" }: { instructorName?: string, studentName?: string, syllabusTitle?: string, syllabusLink?: string }) {
  return (
