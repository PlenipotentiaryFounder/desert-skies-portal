export default function WelcomeStudentEmail({ magicLink = "#", studentName = "Student", syllabusTitle, syllabusLink = "/student/syllabus" }: { magicLink?: string, studentName?: string, syllabusTitle?: string, syllabusLink?: string }) {
  return (
