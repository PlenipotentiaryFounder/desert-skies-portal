  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden group",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-aviation-sunset-200 bg-aviation-sunset-500/10 backdrop-blur-sm text-aviation-sunset-100 hover:bg-aviation-sunset-500/20 hover:border-aviation-sunset-300 hover:scale-105 active:scale-95",
        ...
        glass: "bg-white/10 backdrop-blur-md border border-white/20 text-aviation-sunset-100 shadow-glass hover:bg-white/20 hover:shadow-glass-dark hover:scale-105 active:scale-95",
        glassDark: "bg-black/20 backdrop-blur-md border border-white/10 text-aviation-sunset-100 shadow-glass-dark hover:bg-black/30 hover:scale-105 active:scale-95",
